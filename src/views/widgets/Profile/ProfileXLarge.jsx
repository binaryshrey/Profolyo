...
const ProfileXLarge = ({ userData, clickToAdd }) => {
  ...
  const profile = { i: uuidv4(), x: 0, y: 1, w: 4, h: 4, size: 'large', type: 'ProfileXLarge', component: 'ProfileXLarge' };
  ...
  return (
    <div className="border rounded-lg flex flex-col justify-between h-full p-3 shadow-md cursor-pointer bg-profolyoWidget" onClick={handleClickToAdd}>
      ...
      <img src={userData?.AvatarURL} alt="profile" referrerPolicy="no-referrer" className="w-64 h-64 rounded-lg mt-2 object-cover" />
